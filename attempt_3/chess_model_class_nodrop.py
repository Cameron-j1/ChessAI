...
class ChessModelSpatial(nn.Module):
    def __init__(self, num_residual_blocks=8, dropout_rate=0.2):
        ...
        # Add dropout after residual tower
        self.post_residual_dropout = nn.Dropout2d(dropout_rate)
    ...
    def forward(self, x):
        ...
        # Apply dropout after residual tower
        x = self.post_residual_dropout(x)
